...
# Code Details
The uploaded codes on Parallel MRI Brain reconstruction have been written in python-3.7 using the Tensorflow-1.15 platform. 
The descriptions of the python scripts are:
